...
cfg.MODEL.POSITION_EMBEDDING = 'None'  # sine or learned
...
cfg.DATA.MAX_SAMPLE_INTERVAL = [20,40,80]
# DATA.TRAIN
cfg.DATA.TRAIN = edict()
cfg.DATA.TRAIN.DATASETS_NAME = ["LASOT", "GOT10K_vottrain","COCO17"]
...
cfg.DATA.SEARCH.ERROR_CENTER_JITTER = 0
cfg.DATA.SEARCH.ERROR_SCALE_JITTER = 0
# DATA.TEMPLATE
cfg.DATA.TEMPLATE = edict()
cfg.DATA.TEMPLATE.NUMBER = 4
cfg.DATA.TEMPLATE.SIZE = 128
cfg.DATA.TEMPLATE.FACTOR = 2.0
cfg.DATA.TEMPLATE.CENTER_JITTER = 0
cfg.DATA.TEMPLATE.SCALE_JITTER = 0
cfg.DATA.TEMPLATE.ERROR_CENTER_JITTER = 0.9
cfg.DATA.TEMPLATE.ERROR_SCALE_JITTER = 0.1
...
cfg.TEST.UPDATE_INTERVALS.LASOT = [20,40,80]
cfg.TEST.UPDATE_INTERVALS.GOT10K_TEST = [20,40,80]
cfg.TEST.UPDATE_INTERVALS.TRACKINGNET = [20,40,80]
cfg.TEST.UPDATE_INTERVALS.VOT20 = [2,4,8]
cfg.TEST.UPDATE_INTERVALS.VOT20LT = [20,40,80]
