...
def run_training(script_name, config_name, cudnn_benchmark=True, local_rank=-1, save_dir=None, base_seed=None,
    ...
    if distill:
        ...
        #expr_module = importlib.import_module('lib.train.train_settings.{}.{}'.format(script_name, script_name))
...
def main():
    ...
    parser.add_argument('--seed', type=int, default=time.time(), help='seed for random numbers') # 每次恢复训练，可能会重复采样
